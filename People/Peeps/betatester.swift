...
class betatester: UIView {
    ...
    */
    ...
    override func layoutSubviews() {
        ...
        let partitionValue = "peeps=\(ID.selected)"
            ...
            case .success(let realm):
                ...
                if let me = realm.objects(myPeeps.self).first {
                    if let beta = me.betaTester {
                        self.betalabel.text = "\(ID.selected) downloaded peeple a social app beta on \(beta.dateDownloaded)"
                    } else {
                        ...
                        self.betalabel.text = "\(ID.selected) downloaded peeple a social app beta on \(currentDateTime)"
